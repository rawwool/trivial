...
/// </summary>
[Serializable()]
public class ExtendedRichTextBox : RichTextBoxExx
{
    #region CONSTRUCTOR
    ...
    public void SetLayoutType(LayoutModes eViewMode)
    {
        ...
        switch (eViewMode)
        {
            ...
            case LayoutModes.WordWrap:
                if (!IsDesginMode) SendMessage(new HandleRef(this, this.Handle), EM_SETTARGETDEVICE, 0, 0);
                break;
            case LayoutModes.Default:
                if (!IsDesginMode) SendMessage(new HandleRef(this, this.Handle), EM_SETTARGETDEVICE, 0, 1);
                break;
        }
    }
    #endregion
    ...
    public UnderlineStyle SelectionUnderlineStyle
    {
        get
        {
            ...
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_GETCHARFORMAT, SCF_SELECTION, ref fmt);
        ...
        set
        {
            ...
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_SETCHARFORMAT, SCF_SELECTION, ref fmt);
        }
    }
    ...
    public new RichTextAlign SelectionAlignment
    {
        get
        {
            ...
            fmt.cbSize = Marshal.SizeOf(fmt);
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_GETPARAFORMAT, SCF_SELECTION, ref fmt);
        ...
        set
        {
            ...
            // Set the alignment 
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_SETPARAFORMAT, SCF_SELECTION, ref fmt);
        }
    }
    ...
    public CharStyle SelectionCharStyle
    {
        get
        {
            ...
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_GETCHARFORMAT, SCF_SELECTION, ref param);
        ...
        set
        {
            ...
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_SETCHARFORMAT, SCF_SELECTION, ref param);
        }
    }
    ...
    public ParaLineSpacing SelectionLineSpacing
    {
        get 
        {
            ...
            param.cbSize = Marshal.SizeOf(param);
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_GETPARAFORMAT, SCF_SELECTION, ref param);
    ...
    public int SelectionSpaceBefore
    {
        ...
        set
        {
            ...
            if (!IsDesginMode) SendMessage(new HandleRef(this, Handle), EM_SETPARAFORMAT, SCF_SELECTION, ref param);
        }
    }
    /// <summary>
...
*/
    ...
    public interface IStorage
    {
        ...
        int SetElementTimes(
            /* [string][unique][in] */ string pwcsName,
            /* [unique][in] */CT.FILETIME pctime,
            /* [unique][in] */CT.FILETIME patime,
            /* [unique][in] */CT.FILETIME pmtime);
